        ...
        <div className="max-w-lg w-full">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-700/50 p-8 shadow-2xl shadow-emerald-500/10">
            ...
            <div className="relative z-10 text-center">
              <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-amber-500/20 to-amber-600/10 rounded-full flex items-center justify-center border-2 border-amber-500/30">
                <svg
              ...
              <p className="text-amber-400 font-medium mb-6">
                We are manually verifying your UPI transaction
              </p>
              ...
              <p className="text-gray-400 text-sm mb-6">
                Your registration data is safely recorded. Our treasury team will physically cross-verify the UTR number with bank statements within 24 hours.
                <br />
